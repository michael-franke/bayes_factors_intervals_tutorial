...
We will combine two statistical concepts to make this evaluation: First, we define a region of practical equivalence (ROPE) that will represent a reasonable range of pitch values around zero that we consider to be not meaningful  [@kruschke_Rejecting_journalarticle_2018].
