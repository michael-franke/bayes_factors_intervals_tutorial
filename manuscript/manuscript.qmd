...
# NOTE TR: calling individual lines is probably confusing to the reader, I suggest we just using the generic command. But yeah the column wrangling is strange. When choosing the first 4 columns it also displays most of them as flat, so something is off there. Made an attempt...
...
- point to Kruschke's catalog of best practices [@Kruschke2021-Bayesian-Analys]
