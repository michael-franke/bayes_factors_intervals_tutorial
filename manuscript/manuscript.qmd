...
# NOTE  if we change the column names in the source we do not have to have the wrangling in here, making the code  chunk slimmer.
...
The combination of Bayes Factors is visualized in @sensitivity_plot. Orange cells indicate evidence for the alternative.
