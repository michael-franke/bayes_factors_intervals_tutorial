...
favor of the alternative hypothesis for the given ROPE is around 1.64.
...
right). * {[} {]} This is not surprising and a known phenomenon, often
discussed under the Jeffreys-Lindley paradox
(\citeproc{ref-lindley_Statistical_journalarticle_1957}{Lindley, 1957}):
The more diffuse the priors are (i.e., wider priors), the more
