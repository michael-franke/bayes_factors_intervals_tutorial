...
more robust than point-valued hypothesis testing. This method does not
seem to be commonly known, it is conceptually simple and easy to apply,
e.g., through implementation in the package \texttt{bayesfactorR}. This
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/sensitivity_plot-1.pdf}}
...
(\citeproc{ref-sensitivity_plot}{\textbf{sensitivity\_plot?}}). Orange
cells indicate evidence for the alternative. Green cells indicate
...
(\citeproc{ref-winter2019statistics}{2019}). -
